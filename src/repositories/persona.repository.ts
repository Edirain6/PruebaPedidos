...
> {
  ...
  constructor(
    @inject('datasources.monogdb') dataSource: MonogdbDataSource, @repository.getter('PedidosRepository') protected pedidosRepositoryGetter: Getter<PedidosRepository>,
  ) {
